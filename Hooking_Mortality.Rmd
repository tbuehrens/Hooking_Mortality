...
#save results
saveRDS(brm_coho, file = here(paste0("results/","coho_", modname,"_",priorname,".rds")))
}else{
  brm_coho<-readRDS(here(paste0("results/","coho_", modname,"_",priorname,".rds")))
}
...
save(file = here(paste0("results/","coho_",modname,"_",priorname,"_outputs",".rda")),
  ...
  load(here(paste0("results/","coho_",modname,"_",priorname,"_outputs",".rda")))
}
