...
brm_cohocrit = brm(formula = crit_resp ~ Gear_cap:Method_cap
          ,data=cdat_treat
          ,family = bernoulli(link="logit")
          #,method = "REML"
          ,cores = 4
...
saveRDS(brm_cohocrit, file = "results/coho_crithook_model.rds")

mod_effplots = plot(conditional_effects(brm_cohocrit), points = T, ask = F)


cov_comb = covComb(cdat_treat, c("Gear_cap", "Method_cap"))%>%
  filter(Gear_cap != "Control")
comb_names = apply(cov_comb, 1, paste, collapse = "_")
...
save(mod_effplots, meff_quant,file = "results/coho_crithook_model_gearmethod.rda")
```
